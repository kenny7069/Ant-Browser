...
|---|---|
| Ant-Browser | `fd31252` (C8 installed signed update/rollback local gate passes and five-platform jobs are wired; native results pending; basic gates passed at `0841cd5`; full C8 remains in progress; C7 `4f5ba88`; baseline `e83fc37ad5271034aba35f4d6b5a8b7ee3d394c1`) |
